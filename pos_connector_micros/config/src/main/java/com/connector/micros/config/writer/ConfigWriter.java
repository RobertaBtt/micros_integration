...
public class ConfigWriter {
    ...
    public ConfigWriter(String applicationPropertiesFile) {
        ConfigReader.getInstance(applicationPropertiesFile);
    }

    public static void writePropertiesToFileByConfigType(String externalPropertiesFile, String configType) throws IOException {
