...
public class GetVersionTest extends junit.framework.TestCase {
    ...
    private Integer versionEnumDefiniton = Integer.valueOf(configReader.getProperty(ApplicationProperty.ENUM_VERSION));
    ...
    public void testVersion() {
        ...
        try {
            response = microsService.getConfigurationInfo(
                    employeeObjectNumber,
                    versionEnumDefiniton,
                    revenueCenter);
        ...
        assertEquals("VERSION", configInfoTypeValue);
    }
