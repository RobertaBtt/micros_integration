...
/**
 * PostTransactionExResponse bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class PostTransactionExResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static PostTransactionExResponse parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PostTransactionExResponse object = new PostTransactionExResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PostTransactionExResponse".equals(type)) {
                            ...
                            return (PostTransactionExResponse) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
