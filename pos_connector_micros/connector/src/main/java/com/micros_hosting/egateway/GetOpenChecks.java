...
/**
 * GetOpenChecks bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class GetOpenChecks implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":GetOpenChecks", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "GetOpenChecks", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetOpenChecks parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetOpenChecks object = new GetOpenChecks();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetOpenChecks".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (GetOpenChecks) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
