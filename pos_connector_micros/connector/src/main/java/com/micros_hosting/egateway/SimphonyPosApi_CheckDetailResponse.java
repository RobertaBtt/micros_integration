/**
 * SimphonyPosApi_CheckDetailResponse.java
 * <p>
...
/**
 * SimphonyPosApi_CheckDetailResponse bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class SimphonyPosApi_CheckDetailResponse implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of dbName that had
       name = SimphonyPosApi_CheckDetailResponse
    ...
    /**
     * field for CheckDetail
     */
    protected java.lang.String localCheckDetail;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localCheckDetailTracker = false;
    ...
    public boolean isCheckDetailSpecified() {
        return localCheckDetailTracker;
    }
    ...
    public java.lang.String getCheckDetail() {
        return localCheckDetail;
    }

    /**
     * Auto generated setter method
     *
     * @param param CheckDetail
     */
    public void setCheckDetail(java.lang.String param) {
        localCheckDetailTracker = param != null;

        this.localCheckDetail = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":SimphonyPosApi_CheckDetailResponse",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "SimphonyPosApi_CheckDetailResponse", xmlWriter);
            }
        }
        ...
        if (localCheckDetailTracker) {
            namespace = "http://micros-hosting.com/EGateway/";
            writeStartElement(null, namespace, "CheckDetail", xmlWriter);

            if (localCheckDetail == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                        "CheckDetail cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localCheckDetail);
            }
    ...
    public static class Factory {
         ...
         */
        public static SimphonyPosApi_CheckDetailResponse parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SimphonyPosApi_CheckDetailResponse object = new SimphonyPosApi_CheckDetailResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SimphonyPosApi_CheckDetailResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (SimphonyPosApi_CheckDetailResponse) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                                "http://micros-hosting.com/EGateway/", "CheckDetail").equals(
                                reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "CheckDetail" +
                                        "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setCheckDetail(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
