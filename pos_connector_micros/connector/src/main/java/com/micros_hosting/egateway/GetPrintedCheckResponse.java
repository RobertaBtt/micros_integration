...
/**
 * GetPrintedCheckResponse bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class GetPrintedCheckResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":GetPrintedCheckResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "GetPrintedCheckResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetPrintedCheckResponse parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetPrintedCheckResponse object = new GetPrintedCheckResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetPrintedCheckResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (GetPrintedCheckResponse) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
