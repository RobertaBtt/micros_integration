/**
 * SimphonyPosApi_OperationalResult.java
 * <p>
...
/**
 * SimphonyPosApi_OperationalResult bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class SimphonyPosApi_OperationalResult implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of dbName that had
       name = SimphonyPosApi_OperationalResult
     ...
     * field for ErrorCode
     */
    protected com.micros_hosting.egateway.TransactionServices_ErrorCode localErrorCode;
     ...
     * Auto generated getter method
     *
     * @return com.micros_hosting.egateway.TransactionServices_ErrorCode
     */
    public com.micros_hosting.egateway.TransactionServices_ErrorCode getErrorCode() {
    ...
    public void setErrorCode(
            com.micros_hosting.egateway.TransactionServices_ErrorCode param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":SimphonyPosApi_OperationalResult",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "SimphonyPosApi_OperationalResult", xmlWriter);
            }
        }
        ...
        localErrorCode.serialize(new javax.xml.namespace.QName(
                "http://micros-hosting.com/EGateway/", "ErrorCode"), xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static SimphonyPosApi_OperationalResult parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SimphonyPosApi_OperationalResult object = new SimphonyPosApi_OperationalResult();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SimphonyPosApi_OperationalResult".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (SimphonyPosApi_OperationalResult) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                                "http://micros-hosting.com/EGateway/", "Success").equals(
                                reader.getName())) {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                                "http://micros-hosting.com/EGateway/", "ErrorCode").equals(
                                reader.getName())) {
                    object.setErrorCode(com.micros_hosting.egateway.TransactionServices_ErrorCode.Factory.parse(
                            reader));
