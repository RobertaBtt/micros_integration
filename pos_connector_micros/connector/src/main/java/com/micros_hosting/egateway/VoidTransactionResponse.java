...
/**
 * VoidTransactionResponse bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class VoidTransactionResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static VoidTransactionResponse parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            VoidTransactionResponse object = new VoidTransactionResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"VoidTransactionResponse".equals(type)) {
                            ...
                            return (VoidTransactionResponse) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
