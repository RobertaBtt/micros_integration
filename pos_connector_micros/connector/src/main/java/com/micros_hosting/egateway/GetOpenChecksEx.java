...
/**
 * GetOpenChecksEx bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class GetOpenChecksEx implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":GetOpenChecksEx", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "GetOpenChecksEx", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetOpenChecksEx parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetOpenChecksEx object = new GetOpenChecksEx();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetOpenChecksEx".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (GetOpenChecksEx) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
