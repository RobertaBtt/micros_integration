...
public class EAccountDataSource implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final EAccountDataSource SOURCE_UNDEFINED = new EAccountDataSource(_SOURCE_UNDEFINED,
            true);
    public static final EAccountDataSource MAGNETIC_STRIPE = new EAccountDataSource(_MAGNETIC_STRIPE,
            true);
    public static final EAccountDataSource RFID_TRACK_DATA_RULES = new EAccountDataSource(_RFID_TRACK_DATA_RULES,
            true);
    public static final EAccountDataSource RFID_M_CHIP_RULES = new EAccountDataSource(_RFID_M_CHIP_RULES,
            true);
    public static final EAccountDataSource MANUALLY_KEYED_TRACK_1_CAPABLE = new EAccountDataSource(_MANUALLY_KEYED_TRACK_1_CAPABLE,
            true);
    public static final EAccountDataSource MANUALLY_KEYED_TRACK_2_CAPABLE = new EAccountDataSource(_MANUALLY_KEYED_TRACK_2_CAPABLE,
            true);
    public static final EAccountDataSource MANUALLY_KEYED_NO_CARD_READER = new EAccountDataSource(_MANUALLY_KEYED_NO_CARD_READER,
            true);

    /**
     * field for EAccountDataSource
     */
    protected java.lang.String localEAccountDataSource;

    // Constructor
    protected EAccountDataSource(java.lang.String value, boolean isRegisterValue) {
        localEAccountDataSource = value;

        if (isRegisterValue) {
            _table_.put(localEAccountDataSource, this);
        }
    }

    public java.lang.String getValue() {
        return localEAccountDataSource;
    }
    ...
    public java.lang.String toString() {
        return localEAccountDataSource.toString();
    }
    ...
    public static class Factory {
        ...
        public static EAccountDataSource fromValue(java.lang.String value)
                throws java.lang.IllegalArgumentException {
            EAccountDataSource enumeration = (EAccountDataSource) _table_.get(value);
        ...
        public static EAccountDataSource fromString(java.lang.String value,
        ...
        public static EAccountDataSource fromString(
            ...
            if (content.indexOf(":") > -1) {
                ...
                return EAccountDataSource.Factory.fromString(content,
                        namespaceUri);
            } else {
                return EAccountDataSource.Factory.fromString(content, "");
            }
         ...
         */
        public static EAccountDataSource parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EAccountDataSource object = null;
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        ...
                        if (content.indexOf(":") > 0) {
                            ...
                            object = EAccountDataSource.Factory.fromString(content,
                                    namespaceuri);
                        } else {
