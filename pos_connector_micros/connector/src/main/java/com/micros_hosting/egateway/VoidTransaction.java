...
/**
 * VoidTransaction bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class VoidTransaction implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":VoidTransaction", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "VoidTransaction", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static VoidTransaction parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            VoidTransaction object = new VoidTransaction();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"VoidTransaction".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (VoidTransaction) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
