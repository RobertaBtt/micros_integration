/**
 * CalculateTransactionTotalsResponse.java
 * <p>
...
/**
 * CalculateTransactionTotalsResponse bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class CalculateTransactionTotalsResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":CalculateTransactionTotalsResponse",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "CalculateTransactionTotalsResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CalculateTransactionTotalsResponse parse(
                javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CalculateTransactionTotalsResponse object = new CalculateTransactionTotalsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CalculateTransactionTotalsResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (CalculateTransactionTotalsResponse) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
