...
import com.micros_hosting.egateway.PostTransactionEx;
...
/**
 * PostTransactionEx bean class
 */
@SuppressWarnings({"unchecked",
        "unused"
})
public class MicrosPostTransactionEx extends PostTransactionEx {
    ...
    public MicrosPostTransactionEx(String namespaceUriServer, String namespaceUri, String targetEndPoint) {
        //super();
        this.namespaceUriServer = namespaceUriServer;
        this.namespaceUri = namespaceUri;
        this.targetEndPoint = targetEndPoint;
        this.MY_QNAME = new QName(namespaceUriServer, "PostTransactionEx", "");
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":PostTransactionEx", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "PostTransactionEx", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PostTransactionEx parse(
                javax.xml.stream.XMLStreamReader reader) throws Exception {
            PostTransactionEx object = new PostTransactionEx();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PostTransactionEx".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (MicrosPostTransactionEx) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new QName(namespaceUri, "pGuestCheck").equals(
                                reader.getName())) {
