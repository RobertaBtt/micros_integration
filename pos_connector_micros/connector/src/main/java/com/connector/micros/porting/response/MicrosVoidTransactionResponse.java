...
import com.micros_hosting.egateway.VoidTransactionResponse;
...
public class MicrosVoidTransactionResponse extends VoidTransactionResponse {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":VoidTransactionResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "VoidTransactionResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static MicrosVoidTransactionResponse parse(
                javax.xml.stream.XMLStreamReader reader) throws Exception {
            MicrosVoidTransactionResponse object = new MicrosVoidTransactionResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"VoidTransactionResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (MicrosVoidTransactionResponse) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
