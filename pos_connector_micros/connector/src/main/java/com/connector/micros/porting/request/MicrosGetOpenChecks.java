...
import com.micros_hosting.egateway.GetOpenChecks;
...
public class MicrosGetOpenChecks extends GetOpenChecks {
    ...
    public MicrosGetOpenChecks(String namespaceUriServer, String namespaceUri, String targetEndPoint) {
        //super();
        this.namespaceUriServer = namespaceUriServer;
        this.namespaceUri = namespaceUri;
        this.targetEndPoint = targetEndPoint;
        this.MY_QNAME = new QName(namespaceUriServer, "GetOpenChecks", "");
    }
    ...
    public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType)
        ...
        if (localOpenChecksTracker) {
            ...
            localOpenChecks.serialize(new QName(namespaceUriServer, "openChecks", ""),
                    xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static GetOpenChecks parse(XMLStreamReader reader) throws Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetOpenChecks".equals(type)) {
                            ...
                            return (MicrosGetOpenChecks) com.micros_hosting.egateway.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new QName(namespaceUri, "openChecks").equals(
                                reader.getName())) {
